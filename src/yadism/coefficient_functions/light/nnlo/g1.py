...
def singlet_reg(z, args):
    ...
    return nf * CF * TR * ( 
        ( 1 + z ) * ( 
            - 16 * Li31mz + 16 * ln1mz * Li21mz - 16 * lnz * Li21mz - 16 * zeta2 * lnz
            + 8 * lnz * ln1mz2 - 16 * lnz2 * ln1mz * 20 * lnz3 / 3.0
            )
            ## Erratum of 2007
            + ( 1 - z ) * ( 20 * ln1mz2 - 88 * ln1mz + 760 / 3)
            - 32 * ( 1 + z2 / 3.0+ z + 1 / z / 3.0) * ( Li2mz + lnz * ln1pz )
            + ( 50 + 16 * z2 / 3.0- 10 * z ) * lnz2 - 32 * ( 2 - z ) * lnz * ln1mz
            + 4 * ( 119 - 13 * z ) * lnz / 3.0- ( 72 + 32 * z2 / 3.0- 40 * z ) * zeta2
           - 8 * ( 3 + z ) * Li21mz
    )      
    # fmt: on
...
def gluon_reg(z, args):
    ...
    return nf * (
        CF * TR * (
            ( 1 - 2 * z ) * ( 
                32 * Li31mz - 16 * ln1mz * Li21mz - 8 * lnz * Li21mz - 24 * zeta2 * lnz
                - 20 * ln1mz3 / 3.0+ 16 * lnz * ln1mz2 - 16 * lnz2 * ln1mz + 10 * lnz3 / 3
            )
            ...
            + ( 123 - 104 * z2 - 48 * z ) * lnz2 / 3.0- ( 88 - 96 * z ) * lnz * ln1mz
            + 6 * ( 9 - 12 * z ) * ln1mz2 - 32 * zeta2 * z2 * ln1mz - 4 * ( 31 - 4 * z2 - 26 * z ) * ln1mz
            + ( 416 - 48 * z2 - 274 * z ) * lnz / 3.0- 8 * ( 5 - 4 * z2 - 26 * z ) * zeta3
            - 4 * ( 81 - 52 * z2 - 108 * z ) * zeta2 / 3.0+ 2 * ( 233 - 239 * z ) / 3.0
        )
        + CA * TR * ( 
            16 * ( 1 + 2 * z ) * ( Li3r - Li3mr - ln1mz * Li2mz - lnz * Li21mz - lnz * ln1mz * ln1pz )
            ...
            - 4 * ( 1 - 2 * z ) * ln1mz3 / 3.0+ 8 * ( 6 - 7 * z ) * ln1mz2
            + 8 * ( 3 + 2 * z2 - 10 * z ) * zeta2 * ln1mz + 4 * ( 7 + 10 * z ) * lnz3 / 3.0
            + 2 * ( 135 + 44 * z2 - 48 * z ) * lnz2 / 3.0- 8 * ( 17 - 16 * z ) * lnz * ln1mz
            + 8 * ( 118 + 3 * z2 - 26 * z ) * lnz / 3.0- 4 * ( 44  + 2 * z2 - 53 * z ) * ln1mz
            - 4 * ( 3 + 4 * z2 + 10 * z ) * zeta3 - 16 * ( 27 + 11 * z2 - 24 * z ) * zeta2 / 3.0
            + 8 * ( 5 + 2 * z ) * ln1mz * Li21mz + 4 * ( 355 - 367 * z ) / 3.0
        )
        # Erratum of 1997
        + CF * TR * ( 
