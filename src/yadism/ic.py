...
def fl_splus_raw(pc):
    return -0.5*((8*pc.delta**4*(pc.m2sq + pc.s1hat)**2 + 2*pc.delta**2*(pc.s1hat*(pc.s1hat*(3*pc.m2sq**2 + pc.m2sq*pc.s1hat - pc.s1hat*(9*pc.Q2 + 2*pc.s1hat)) + 4*(pc.m2sq + pc.s1hat)*(2*pc.m2sq + pc.s1hat)*pc.sigma_pm) - 2*(2*pc.m2sq**2*pc.Q2 + pc.s1hat**2*(pc.Q2 + pc.s1hat) + pc.m2sq*pc.s1hat*(4*pc.Q2 + pc.s1hat))*pc.sigma_pp) + pc.s1hat*(pc.s1hat*(28*pc.m1sq**2*pc.Q2*pc.s1hat + pc.s1hat**2*(4*pc.m2sq**2 + 4*pc.m2sq*pc.s1hat + pc.Q2*pc.s1hat) + 2*pc.m1sq*(-12*pc.m2sq**2*pc.Q2 + pc.s1hat*(14*pc.Q2**2 - 9*pc.Q2*pc.s1hat + 2*pc.s1hat*(pc.s1hat - pc.sigma_pm)) + 2*pc.m2sq*pc.s1hat*(-16*pc.Q2 + pc.s1hat - pc.sigma_pm)) + pc.s1hat*(20*pc.m2sq**2 + 20*pc.m2sq*pc.s1hat - 3*pc.Q2*pc.s1hat)*pc.sigma_pm + 4*pc.m2sq*pc.Q2*pc.sigma_mp*pc.sigma_pm + 18*pc.m2sq*(pc.m2sq + pc.s1hat)*pc.sigma_pm**2) + (4*pc.m1sq*pc.m2sq*pc.Q2*pc.s1hat + pc.s1hat**2*(-pc.deltap**2 + 6*pc.Q2*(pc.m2sq + pc.s1hat) + 7*pc.Q2*pc.sigma_mp) - 8*pc.m2sq*pc.Q2*(2*pc.m2sq + 5*pc.s1hat)*pc.sigma_pm)*pc.sigma_pp + pc.s1hat*(-pc.deltap**2 + 6*pc.Q2*(pc.m2sq + pc.s1hat) - 3*pc.Q2*pc.sigma_mp)*pc.sigma_pp**2))*pc.x)/(pc.deltap**2*pc.Q2*pc.s1hat*(pc.m2sq + pc.s1hat)**2) + (pc.L_xi*(-2*pc.delta**4*(pc.s1hat + pc.sigma_pp) - 2*pc.delta**2*(pc.s1hat + pc.sigma_pp)*(pc.s1hat**2 + 2*pc.s1hat*pc.sigma_pm - pc.Q2*pc.sigma_pp) + pc.s1hat*(pc.Q2*pc.s1hat**2*(pc.s1hat + 4*pc.sigma_pm) - pc.s1hat*(pc.deltap**2 - 7*pc.Q2*pc.sigma_pm)*pc.sigma_pp + 4*pc.Q2*pc.sigma_pm*pc.sigma_pp**2 + 2*pc.m1sq*pc.Q2*pc.s1hat*(-2*pc.m2sq + 6*pc.s1hat + 9*pc.sigma_pp)))*pc.x)/(pc.deltap**3*pc.Q2*pc.s1hat)
...
def fl_sminus_raw(pc):
    return (-2*pc.L_xi*np.sqrt(pc.m1sq * pc.m2sq)*(pc.deltap**2*(2*pc.Q2 - pc.s1hat)*pc.s1hat + 2*pc.Q2*((3*pc.m1sq + pc.m2sq + pc.Q2)*pc.s1hat**2 + (pc.delta**2 + 2*pc.s1hat*pc.sigma_pm)*pc.sigma_pp))*pc.x)/(pc.deltap**3*pc.Q2*pc.s1hat) - (np.sqrt(pc.m1sq * pc.m2sq)*(4*pc.delta**2*pc.Q2*(pc.m2sq + pc.s1hat)*(2*pc.m2sq + pc.s1hat) + pc.deltap**2*pc.s1hat*(4*pc.m2sq*(pc.Q2 - pc.s1hat) + pc.s1hat*(4*pc.Q2 - 3*pc.s1hat + pc.sigma_pp)) + 4*pc.Q2*pc.s1hat*(pc.m2sq + pc.s1hat)*(4*pc.m2sq*pc.sigma_pm + pc.s1hat*(2*pc.s1hat - pc.sigma_mp + 2*(pc.sigma_pm + pc.sigma_pp))))*pc.x)/(pc.deltap**2*pc.Q2*pc.s1hat*(pc.m2sq + pc.s1hat)**2)
