    ...
    def test_gluon(self):
        ...
        for z in [x, 0.9]:
            ...
            for pc in [
                ...
                af2nc.AsyGluonVV(MockESF(x, Q2), 6, mu2hq=M2hq),
                af2nc.AsyGluonAA(MockESF(x, Q2), 3, mu2hq=M2hq),
                aflnc.AsyGluonVV(MockESF(x, Q2), 4, mu2hq=M2hq),
                aflnc.AsyGluonAA(MockESF(x, Q2), 5, mu2hq=M2hq),
